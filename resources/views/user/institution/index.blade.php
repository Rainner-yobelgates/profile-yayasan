...
<div class="container-fluid page-header py-6 my-6 mt-0 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center">
        <h1 class="display-4 text-white animated slideInDown mb-4">{{ $institution->name }}</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a class="text-white" href="{{ route('home') }}">Beranda</a></li>
                <li class="breadcrumb-item"><a class="text-white" href="#">Lembaga</a></li>
                <li class="breadcrumb-item text-primary active" aria-current="page">{{ $institution->name }}</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                <h1 class="display-6 mb-4">{{ $institution->name }}</h1>
            ...
            <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                <img src="{{ asset('storage/'.$institution->logo) }}" style="width: 100%;height: 15rem;object-fit: contain;" class="img-fluid" alt="">
                <h6 class="text-center mt-3">Logo {{ $institution->name }}</h6> 
                <hr>
