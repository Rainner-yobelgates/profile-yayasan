                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            @isset($settings['logo'])
                                <div class="mb-2 border" style="width: 200px">
                                    <img src="{{ asset('storage/' . $settings['logo']) }}" class="img-fluid"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="phone" value="{{ old('phone', $settings['phone'] ?? '') }}"
                        ...
                        <div class="form-group">
                            ...
                            @isset($settings['image-chairman'])
                                <div class="mb-2 border" style="width: 200px">
                                    <img src="{{ asset('storage/' . $settings['image-chairman']) }}" class="img-fluid"
                                        style="object-fit: contain;" alt="Foto Ketua Yayasan">
                                </div>
                            @endisset
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name-chairman" class="form-control"
                                value="{{ old('name-chairman', $settings['name-chairman'] ?? '') }}">
                            @error('name-chairman')
                                <span class="text-danger ml-1">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <label>Meta SEO dan Google Console</label>
                            <textarea name="meta-seo" class="form-control" style="height: 15rem;">{{ $settings['meta-seo'] ?? '' }}</textarea>
                            @error('meta-seo')
                                <span class="text-danger ml-1">{{ $message }}</span>
                            @enderror
                        </div>
